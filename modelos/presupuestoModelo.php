...
class presupuestoModelo extends mainModel
{
    ...
    protected static function agregar_presupuestoC_modelo1($datos)
    {
        ...
        $sql = $conexion->prepare("INSERT INTO presupuesto_compra (idproveedores, id_usuario, id_sucursal, fecha, estado, fecha_venc, total)
                               VALUES(:usuario, :proveedor, :sucursal, now(), 1, :fechaVe, :total)");
