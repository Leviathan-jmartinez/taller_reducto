...
INSERT INTO `nota_remision_detalle` VALUES (7,10,23.0000,56000.00,1288000.00),(7,11,15.0000,45000.00,675000.00),(8,10,23.0000,56000.00,1288000.00),(8,11,15.0000,45000.00,675000.00),(9,10,23.0000,56000.00,1288000.00),(9,11,15.0000,45000.00,675000.00),(10,6,15.0000,45000.00,675000.00),(10,10,12.0000,32333.00,387996.00);
...
INSERT INTO `stock` VALUES (2,1,200,15,10.0000,'2025-12-15 20:24:11',1,49),(2,6,200,15,21.0000,'2025-12-28 20:42:34',1,50),(2,7,200,15,10.0000,'2025-12-28 21:44:44',1,134),(2,8,200,15,7.0000,'2025-12-28 21:44:44',1,135),(2,9,200,15,40.0000,'2025-12-15 20:24:11',1,49),(2,10,200,15,22.0000,'2025-12-28 20:42:34',1,50),(2,11,200,15,0.0000,'2025-12-28 21:44:44',1,136),(2,13,200,15,10.0000,'2025-12-15 20:24:11',1,49);
...
CREATE TABLE `transferencia_stock` (
  ...
  `fecha` datetime NOT NULL DEFAULT current_timestamp(),
  `estado` enum('pendiente','en_transito','recibido','anulado') DEFAULT 'pendiente',
  `observacion` text DEFAULT NULL,
...
CREATE TABLE `transferencia_stock_detalle` (
  ...
  `cantidad` decimal(12,2) NOT NULL,
  PRIMARY KEY (`idtransferencia`,`id_producto`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-12-29 22:18:35
