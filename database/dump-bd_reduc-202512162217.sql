...
CREATE TABLE `nota_compra_detalle` (
  ...
  `valor_exenta` decimal(12,2) DEFAULT 0.00,
  `valor_5` decimal(12,2) DEFAULT 0.00,
  `valor_10` decimal(12,2) DEFAULT 0.00,
  `subtotal` decimal(12,2) GENERATED ALWAYS AS (`valor_exenta` + `valor_5` + `valor_10`) STORED,
...
-- Dump completed on 2025-12-16 22:17:21
