...
CREATE TABLE `ajuste_inventario` (
  ...
  `fecha` date NOT NULL,
  `tipo_inv` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `ajuste_inventario_detalle` (
  ...
  `cantidad_teorica` int unsigned NOT NULL,
  `cantidad_fisica` int unsigned NOT NULL,
...
CREATE TABLE `apercier_cajas` (
  ...
  `nrofac_ini` varchar(60) COLLATE utf8mb4_general_ci NOT NULL,
  `nrofac_fin` varchar(60) COLLATE utf8mb4_general_ci NOT NULL,
  `estado` int unsigned NOT NULL,
...
CREATE TABLE `articulos` (
  ...
  `desc_articulo` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `precio_venta` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `precio_compra` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `bancos` (
  ...
  `banc_nomb` varchar(60) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `banc_direcc` varchar(120) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `banc_tele` varchar(60) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `estado` int unsigned DEFAULT NULL,
...
CREATE TABLE `cajas` (
  ...
  `caj_descri` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `estado` int unsigned NOT NULL,
  `punto_expedicion` int unsigned DEFAULT NULL,
  `first_number` int unsigned DEFAULT NULL,
  `last_number` int unsigned DEFAULT NULL,
...
CREATE TABLE `cargos` (
  ...
  `descripcion` varchar(60) COLLATE utf8mb4_general_ci NOT NULL,
  `estado` int unsigned DEFAULT NULL,
...
CREATE TABLE `categorias` (
  ...
  `cat_descri` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `estado` int unsigned DEFAULT NULL,
...
CREATE TABLE `ciudades` (
  ...
  `ciu_descri` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `estado` int unsigned DEFAULT NULL,
...
CREATE TABLE `clientes` (
  ...
  `doc_number` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `nombre_cliente` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `apellido_cliente` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `direccion_cliente` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `celular_cliente` varchar(15) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `estado_civil` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `estado_cliente` int unsigned DEFAULT NULL,
  `digito_v` varchar(1) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `doc_type` varchar(15) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `email_cliente` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `clientes` VALUES (1,1,'4964127','Juan','Martinez','ruta 2','0986203431','Soltero/a',1,'1','CI',NULL),(2,1,'80016096','Retail S.A.','','ruta 2','0986203431','',1,'7','RUC',NULL),(3,1,'1299450','Gricelda','Martinez','Ruta PY 02 km 31 - Avda Cerro Patiño M7L2','0985518660','Soltero/a',1,'1','CI','gmartinez076@gmail.com'),(4,1,'3216547','Jose','Perez','Ruta PY 02 km 31 - Avda Cerro Patiño M7L2','0986203431','Soltero/a',1,'','CI','jperez076@gmail.com'),(5,2,'80005868','apolo','','asdasd','','',1,'7','RUC',''),(6,1,'80002004','trebolin','','Ruta PY 02 km 31 - Avda Cerro Patiño M7L2','0986203431','',1,'5','RUC','trebolin076@gmail.com'),(7,1,'8000200','trebolin','','Ruta PY 02 km 31 - Avda Cerro Patiño M7L2','0986203431',NULL,1,'5','RUC','trebolins076@gmail.com'),(8,1,'80019656','TEST','','dsfsdfsdfsdf','',NULL,1,'3','RUC',''),(9,3,'80016085','test','','test','',NULL,1,'5','RUC',''),(10,1,'1456789','joselito','test','dsajdlasdjlsajdl','098456123',NULL,1,'','CI','dasdakljsdq@asdas.com'),(11,3,'1234567','asdasdsd','','asdasdasd','','',1,'8','RUC',''),(12,3,'1236547','pedro','perez','asdasd','0985123456','Soltero/a',1,'','CI','pedro@gmail.com');
...
CREATE TABLE `cobro_cheque` (
  ...
  `idforma_cobro` int unsigned NOT NULL,
  `idbancos` int unsigned NOT NULL,
  `total_cheq` int unsigned DEFAULT NULL,
...
CREATE TABLE `cobro_efectivo` (
  `idcobro_efectivo` int unsigned NOT NULL AUTO_INCREMENT,
  `idcobros` int unsigned NOT NULL,
  `idforma_cobro` int unsigned NOT NULL,
  `total_efe` int unsigned DEFAULT NULL,
...
CREATE TABLE `cobro_tarjeta` (
  `idcobro_tarj` int unsigned NOT NULL AUTO_INCREMENT,
  `idcobros` int unsigned NOT NULL,
  `idforma_cobro` int unsigned NOT NULL,
  `identidad_emisora` int unsigned NOT NULL,
  `total_tarj` int unsigned DEFAULT NULL,
...
CREATE TABLE `colores` (
  ...
  `col_descripcion` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `estado` int unsigned DEFAULT NULL,
...
CREATE TABLE `compra_cabecera` (
  ...
  `nro_factura` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `compra_intervalo` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `compra_detalle` (
  ...
  `cantidad_recibida` bigint DEFAULT NULL,
...
CREATE TABLE `depositos` (
  `iddeposito` int unsigned NOT NULL AUTO_INCREMENT,
  `id_sucursal` int unsigned NOT NULL,
  `depos_descri` varchar(120) COLLATE utf8mb4_general_ci NOT NULL,
  `abreviatura` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `estado` int unsigned DEFAULT NULL,
...
CREATE TABLE `detalle_fac` (
  `id_articulo` int unsigned NOT NULL,
  `iddeposito` int unsigned NOT NULL,
  `idfactura` int unsigned NOT NULL,
  `det_cant` int unsigned NOT NULL,
  `det_prec` int unsigned NOT NULL,
  `det_total` int unsigned NOT NULL,
...
CREATE TABLE `diagnostico` (
  `iddiagnostico` int unsigned NOT NULL,
...
CREATE TABLE `diagnostico_detalle` (
  ...
  `detalle_diagnostico` text COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`iddiagnostico`),
...
CREATE TABLE `empleados` (
  ...
  `apellido` varchar(70) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `direccion` varchar(120) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `celular` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `nro_cedula` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `empresa` (
  ...
  `razon_social` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `equipo_trabajo` (
  ...
  `descripciontraba` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `estado` int unsigned DEFAULT NULL,
...
CREATE TABLE `factura` (
  ...
  `fac_tipo` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `forma_cobro` (
  `idforma_cobro` int unsigned NOT NULL AUTO_INCREMENT,
  `formaco_descr` varchar(60) COLLATE utf8mb4_general_ci NOT NULL,
  `estado` int unsigned DEFAULT NULL,
...
CREATE TABLE `libro_compra` (
  ...
  `idcompra_cabecera` int unsigned NOT NULL,
  `iva5` int unsigned NOT NULL,
  `iva10` int unsigned NOT NULL,
  `exenta` int unsigned NOT NULL,
...
CREATE TABLE `marcas` (
  ...
  `mar_descri` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `estado` int unsigned DEFAULT NULL,
...
CREATE TABLE `modelo_auto` (
  ...
  `id_marcas` int unsigned NOT NULL,
  `mod_descri` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `estado` int unsigned DEFAULT NULL,
...
CREATE TABLE `nota_credito_compra` (
  `idnota_creditocompra` int unsigned NOT NULL AUTO_INCREMENT,
  `id_usuario` int unsigned NOT NULL,
  `id_snc_compras` int unsigned NOT NULL,
  `fecha` date NOT NULL,
  `estado` int unsigned NOT NULL,
  `motivo` varchar(30) COLLATE utf8mb4_general_ci NOT NULL,
  `nro_notacre` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `timbrado` int unsigned DEFAULT NULL,
...
CREATE TABLE `nota_credito_compradetalle` (
  `idnota_creditocompra` int unsigned NOT NULL,
  `id_articulo` int unsigned NOT NULL,
  `cantidad` int unsigned DEFAULT NULL,
  `preciouni` int unsigned DEFAULT NULL,
...
CREATE TABLE `nota_credito_venta` (
  `idnota_credito_venta` int unsigned NOT NULL AUTO_INCREMENT,
  `idfactura` int unsigned NOT NULL,
  `id_usuario` int unsigned NOT NULL,
  `fecha` date NOT NULL,
  `estado` int unsigned NOT NULL,
...
CREATE TABLE `nota_credito_ventadetalle` (
  `idnota_credito_venta` int unsigned NOT NULL,
  `cantidad` int unsigned DEFAULT NULL,
...
CREATE TABLE `nota_debito_compra` (
  `idnota_debito_compra` int unsigned NOT NULL AUTO_INCREMENT,
  `id_usuario` int unsigned NOT NULL,
  `idcompra_cabecera` int unsigned NOT NULL,
  `motivo` int unsigned NOT NULL,
  `estado` int unsigned NOT NULL,
  `fecha` date NOT NULL,
  `nro_notadebi` int unsigned DEFAULT NULL,
  `timbrado` int unsigned DEFAULT NULL,
  `timbrado_venc` date DEFAULT NULL,
...
CREATE TABLE `nota_debito_compradetalle` (
  `idnota_debito_compra` int unsigned NOT NULL,
  `id_articulo` int unsigned NOT NULL,
  `iddeposito` int unsigned NOT NULL,
...
CREATE TABLE `nota_debito_venta` (
  `idnota_debito_venta` int unsigned NOT NULL AUTO_INCREMENT,
  `id_usuario` int unsigned NOT NULL,
  `idfactura` int unsigned NOT NULL,
  `fecha` date NOT NULL,
  `estado` int unsigned NOT NULL,
...
CREATE TABLE `nota_debito_ventadetalle` (
  `idnota_debito_venta` int unsigned NOT NULL,
  `total` int unsigned DEFAULT NULL,
  `cantidad` int unsigned DEFAULT NULL,
  PRIMARY KEY (`idnota_debito_venta`),
...
CREATE TABLE `nota_remision` (
  ...
  `id_usuario` int unsigned NOT NULL,
  `nombre_transpo` varchar(120) COLLATE utf8mb4_general_ci NOT NULL,
  `ci_transpo` int unsigned NOT NULL,
  `cel_transpo` varchar(60) COLLATE utf8mb4_general_ci NOT NULL,
  `fechaenvio` date NOT NULL,
  `fechallegada` date NOT NULL,
  `Vehimarca` varchar(60) COLLATE utf8mb4_general_ci NOT NULL,
  `Vehimodelo` varchar(60) COLLATE utf8mb4_general_ci NOT NULL,
  `Vehichapa` varchar(60) COLLATE utf8mb4_general_ci NOT NULL,
  `estado` int unsigned DEFAULT NULL,
  `transportista` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ruc_transport` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `motivo_remision` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `orden_trabajo` (
  `idordentrabajo` int unsigned NOT NULL AUTO_INCREMENT,
  `idpresupuesto_servicio` int unsigned NOT NULL,
  `id_usuario` int unsigned NOT NULL,
  `estado` int unsigned NOT NULL,
  `tiposervicio` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `orden_trabajo_detalle` (
  `idordentrabajo` int unsigned NOT NULL,
...
CREATE TABLE `presupuesto_detalleservicio` (
  ...
  `idpresupuesto_servicio` int unsigned NOT NULL,
  `cantidad` int unsigned NOT NULL,
  `preciouni` int unsigned NOT NULL,
...
CREATE TABLE `promociones_descuentos` (
  `idpromociones_descuentos` int unsigned NOT NULL AUTO_INCREMENT,
  `id_usuario` int unsigned NOT NULL,
  `estado` int unsigned NOT NULL,
...
CREATE TABLE `promociones_descuentos_detalle` (
  `id_articulo` int unsigned NOT NULL,
  `idpromociones_descuentos` int unsigned NOT NULL,
...
CREATE TABLE `proveedores` (
  ...
  `id_ciudad` int unsigned NOT NULL,
  `razon_social` varchar(70) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `reclamos` (
  `idreclamos` int unsigned NOT NULL AUTO_INCREMENT,
  `id_usuario` int unsigned NOT NULL,
...
CREATE TABLE `reclamos_servicio` (
  `idreclamos` int unsigned NOT NULL,
  `idregistro_servicio` int unsigned NOT NULL,
  `cantidad` int unsigned DEFAULT NULL,
...
CREATE TABLE `registro_servicio_detalle` (
  ...
  `id_articulo` int unsigned NOT NULL,
  `cantidad` int unsigned DEFAULT NULL,
  `precio_uni` int unsigned DEFAULT NULL,
...
CREATE TABLE `snc_compras` (
  `id_snc_compras` int unsigned NOT NULL AUTO_INCREMENT,
  `id_usuario` int unsigned NOT NULL,
  `id_sucursal` int unsigned NOT NULL,
  `idproveedores` int unsigned NOT NULL,
  `fecha` date DEFAULT NULL,
...
CREATE TABLE `stock` (
  ...
  `id_articulo` int unsigned NOT NULL,
  `cantidad` int unsigned DEFAULT NULL,
  `cant_max` int unsigned DEFAULT NULL,
  `cant_min` int unsigned DEFAULT NULL,
...
CREATE TABLE `sucursales` (
  ...
  `suc_descri` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `suc_direccion` varchar(120) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `suc_telefono` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `timbrado` (
  `idtimbrado` int unsigned NOT NULL AUTO_INCREMENT,
  `numero_tim` int unsigned NOT NULL,
  `fecha_ini` date NOT NULL,
  `fecha_venc` date NOT NULL,
  `nro_fac_desde` int unsigned NOT NULL,
  `nro_fac_hasta` int unsigned NOT NULL,
  `estado` int unsigned DEFAULT NULL,
...
CREATE TABLE `tipo_impuesto` (
  ...
  `tipo_impuesto_descri` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `estado` int unsigned DEFAULT NULL,
  PRIMARY KEY (`idiva`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `transferencias` (
  `idtransferencias` int unsigned NOT NULL AUTO_INCREMENT,
  `idnota_remision` int unsigned NOT NULL,
  `id_usuario` int unsigned NOT NULL,
  `id_sucursal` int unsigned NOT NULL,
  `estado` int unsigned NOT NULL,
...
CREATE TABLE `transferencias_detalles` (
  `id_articulo` int unsigned NOT NULL,
  `idtransferencias` int unsigned NOT NULL,
  `cantidad_transf` int unsigned DEFAULT NULL,
...
CREATE TABLE `unidad_medida` (
  ...
  `medida` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
  `estado` int unsigned DEFAULT NULL,
...
CREATE TABLE `usuarios` (
  ...
  `usu_nombre` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `usu_clave` varchar(70) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `usu_nivel` int unsigned DEFAULT NULL,
  `usu_estado` int unsigned DEFAULT NULL,
  `usu_nick` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `usu_apellido` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `usu_email` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `usu_telefono` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `usu_ci` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `vehiculos` (
  ...
  `nro_serie` int unsigned DEFAULT NULL,
  `placa` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `anho` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `estado` int unsigned DEFAULT NULL,
...
-- Dump completed on 2025-03-10 21:43:33
