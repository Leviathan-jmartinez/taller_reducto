...
<div class="container-fluid">
	<ul class="full-box list-unstyled page-nav-tabs">
		...
		<?php if (mainModel::tienePermiso('usuarios.ver')) { ?>
			...
			<li>
				<a  class="active" href="<?php echo SERVERURL; ?>usuario-buscar/">
					<i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR USUARIO
				</a>
			</li>
		<?php } ?>
...
?>
	...
	<div class="container-fluid">
		...
		$ins_usuario->paginador_usuario_controlador($pagina[1], 10, $_SESSION['id_str'], $pagina[0], $_SESSION['busqueda_usuario']);
		?>
	</div>
<?php
}
