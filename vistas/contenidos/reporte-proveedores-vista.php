...
<div class="full-box page-header">
    <h3 class="text-left">
        <i class="fas fa-truck"></i> &nbsp; REPORTE DE PROVEEDORES
    </h3>
</div>
...
<div class="container-fluid">
    ...
    <form id="formPreview" class="form-neon" autocomplete="off">
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <label>Buscar (Razón social / RUC)</label>
...
<form id="formPdf"
    ...
    target="_blank"
    class="d-none">
    <input type="hidden" name="accion" value="imprimir_reporte_proveedores">
    <input type="hidden" name="estado">
    <input type="hidden" name="buscar">
</form>

<!-- RESUMEN -->
<div class="container-fluid mt-3" id="resumenProv" style="display:none;">
...
<div class="container-fluid mt-3">
    <div class="table-responsive">
        <table class="table table-dark table-sm" id="tablaProv">
...
<script>
    document.getElementById("formPreview").addEventListener("submit", function(e) {
        ...
        fetch("<?php echo SERVERURL; ?>ajax/reportesAjax.php", {
            ...
            .then(json => {
                // Resumen
                document.getElementById("resumenProv").style.display = "block";
                ...
                let tbody = document.querySelector("#tablaProv tbody");
                tbody.innerHTML = "";
