...
if (!mainModel::tienePermiso('servicio.promocion.ver')) {
...
<div class="container-fluid">
    ...
    <form method="GET" class="form-neon mb-3">
        <div class="row">
            ...
            <div class="col-md-2 d-flex align-items-end">
                ...
                <a href="<?= SERVERURL; ?>promocion-lista/" class="btn btn-secondary btn-sm">
    ...
    <?php
    echo $insPromocion->listar_promociones_controlador($pagina[1], 15, $pagina[0]);
    ?>
</div>
